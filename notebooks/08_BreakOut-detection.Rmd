...
# Introduction
For outliers detection in the raw meters dataset will be used the [Breakout Detection package](https://github.com/twitter/BreakoutDetection) developed by Twitter. A brief introduction about this package can be found [here](https://blog.twitter.com/engineering/en_us/a/2014/breakout-detection-in-the-wild.html). Cleaned meter data (outliers and 24hs zero readings removed) are used for this analysis.
